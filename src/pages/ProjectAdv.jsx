    ...
    <div className="max-w-7xl mx-auto sm:px-4 py-4 ">
      ...
      <div className="flex flex-col items-center mb-8 sm:mb-16">
        <div className="relative w-full">
          ...
          <div className="flex gap-2 mb-4 w-full scroll-smooth scrollbar-hide snap-x" id="projectScroll">
            {projectData.projects.map((project, index) => (
              <div
                ...
                className={`flex-shrink-0 cursor-pointer rounded-md overflow-hidden backdrop-blur-lg bg-white/40 border transition-all duration-300 hover:shadow-md transform hover:-translate-y-0.5 hover:scale-102 snap-center ${
              ...
              >
                <div className="w-32 sm:w-40">
                  ...
                  <div className="p-2 backdrop-blur-sm bg-white/60">
                    <h3 className={`text-xs sm:text-sm font-medium transition-all duration-200 ${
                      currentProject === index
          ...
          <button 
            onClick={() => {
              document.getElementById('projectScroll').scrollLeft -= 200;
            }}
            className="absolute -left-2 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-md p-2 rounded-full shadow-md hover:bg-white transition-all duration-200 border border-white/50 hover:scale-105 hover:shadow-lg"
          >
          ...
          <button
            ...
            className="absolute -right-2 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-md p-2 rounded-full shadow-md hover:bg-white transition-all duration-200 border border-white/50 hover:scale-105 hover:shadow-lg"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
